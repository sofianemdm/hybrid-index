  ...
  Future<void> _delete(WodResultItem r) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(t.historyDeleteBody(_name(r), _date(r.performedAt)),
  ...
  Widget _tile(WodResultItem r) {
    return GestureDetector(
      onTap: () => Navigator.of(context).push(MaterialPageRoute(
          builder: (_) => WodDetailScreen(wodId: r.wodId, wodName: _name(r)))),
      child: Container(
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(_name(r), style: HiType.titleM.copyWith(color: HiColors.textPrimary)),
