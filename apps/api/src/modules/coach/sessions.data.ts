...
export const SESSIONS: Session[] = [
  ...
  { id: "power-kb-swings-emom", name: "EMOM kettlebell swings", primaryAttribute: "power", secondaryAttributes: ["engine", "hybrid"], requiresEquipment: true, durationMin: 16, intensity: "high", description: "EMOM 16 min : 15 swings explosifs/min. La hanche propulse, bras relâchés. Puissance de hanche et cardio. Adapte le poids." },
  ...
  // MUSCULAR_ENDURANCE
  { id: "musend-pushups-amrap", name: "AMRAP pompes — 10 min", primaryAttribute: "muscular_endurance", secondaryAttributes: ["strength"], requiresEquipment: false, durationMin: 10, intensity: "medium", description: "AMRAP 10 min : 10 pompes + 10 squats en boucle, rythme régulier. Ne pars pas trop vite. Endurance haut du corps et jambes." },
  { id: "musend-bodyweight-circuit", name: "Circuit poids du corps 4 tours", primaryAttribute: "muscular_endurance", secondaryAttributes: ["engine", "hybrid"], requiresEquipment: false, durationMin: 30, intensity: "medium", description: "4 tours : 20 squats, 15 pompes, 20 fentes, 30 s de gainage, 60 s de repos. Résistance générale. Exécution propre jusqu'au bout." },
  ...
  { id: "musend-wallballs-amrap", name: "AMRAP wall balls", primaryAttribute: "muscular_endurance", secondaryAttributes: ["power", "engine"], requiresEquipment: true, durationMin: 12, intensity: "high", description: "AMRAP 12 min de wall balls à rythme soutenu. Endurance jambes + épaules, mouvement signature HYROX. Séries de 10-15 sans poser." },
  ...
  { id: "hybrid-chipper-bodyweight", name: "Enchaînement poids du corps", primaryAttribute: "hybrid", secondaryAttributes: ["muscular_endurance", "engine"], requiresEquipment: false, durationMin: 24, intensity: "high", description: "Pour temps : 50 squats, 40 mountain climbers, 30 pompes, 20 burpees, 10 tuck jumps. Sans matériel. Découpe en petites séries." },
