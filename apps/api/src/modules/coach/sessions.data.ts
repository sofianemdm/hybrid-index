...
export const SESSIONS: Session[] = [
  ...
  // MUSCULAR_ENDURANCE
  { id: "musend-pushups-amrap", name: "AMRAP pompes — 10 min", primaryAttribute: "muscular_endurance", secondaryAttributes: ["strength"], requiresEquipment: false, durationMin: 10, intensity: "medium", description: "AMRAP 10 min : 10 pompes + 10 air squats en boucle, rythme régulier. Ne pars pas trop vite. Endurance haut du corps et jambes." },
  ...
  { id: "hybrid-chipper-bodyweight", name: "Enchaînement poids du corps", primaryAttribute: "hybrid", secondaryAttributes: ["muscular_endurance", "engine"], requiresEquipment: false, durationMin: 24, intensity: "high", description: "Pour temps : 50 air squats, 40 mountain climbers, 30 pompes, 20 burpees, 10 tuck jumps. Sans matériel. Découpe en petites séries." },
