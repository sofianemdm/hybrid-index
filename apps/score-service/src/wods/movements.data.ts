...
export const MOVEMENTS: MovementDef[] = [
  ...
  { id: "push_up", name: "Push-up", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.64, rate: r(0.83, 0.7, 0.5, 0.4, 0.28, 0.2), attributes: [{ attribute: "muscular_endurance", weight: 0.6 }, { attribute: "strength", weight: 0.4 }], fatigueExponent: 1.18 },
  ...
  { id: "lunge", name: "Walking lunge", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.85, rate: r(0.7, 0.65, 0.45, 0.4, 0.3, 0.26), attributes: [{ attribute: "muscular_endurance", weight: 0.7 }, { attribute: "strength", weight: 0.2 }, { attribute: "power", weight: 0.1 }], fatigueExponent: 1.15 },
  ...
  { id: "wall_walk", name: "Wall walk", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.9, rate: r(0.3, 0.24, 0.14, 0.1, 0.06, 0.03), attributes: [{ attribute: "strength", weight: 0.5 }, { attribute: "muscular_endurance", weight: 0.4 }, { attribute: "engine", weight: 0.1 }], fatigueExponent: 1.4 },
  ...
  { id: "clean", name: "Power clean", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.76, rate: r(0.55, 0.46, 0.28, 0.22, 0.14, 0.1), attributes: [{ attribute: "power", weight: 0.55 }, { attribute: "strength", weight: 0.35 }, { attribute: "muscular_endurance", weight: 0.1 }], fatigueExponent: 1.45 },
  { id: "clean_and_jerk", name: "Clean & jerk", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.76, rate: r(0.5, 0.42, 0.25, 0.19, 0.12, 0.08), attributes: [{ attribute: "power", weight: 0.55 }, { attribute: "strength", weight: 0.35 }, { attribute: "muscular_endurance", weight: 0.1 }], fatigueExponent: 1.48 },
  { id: "snatch", name: "Power snatch", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.54, rate: r(0.52, 0.44, 0.24, 0.18, 0.11, 0.07), attributes: [{ attribute: "power", weight: 0.6 }, { attribute: "strength", weight: 0.3 }, { attribute: "speed", weight: 0.1 }], fatigueExponent: 1.5 },
