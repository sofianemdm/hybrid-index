...
export const MOVEMENTS: MovementDef[] = [
  ...
  { id: "mountain_climber", name: "Mountain climber", category: "gymnastics", unit: "rep", requiresEquipment: false, rate: r(1.6, 1.4, 1.1, 0.95, 0.75, 0.65), attributes: [{ attribute: "engine", weight: 0.45 }, { attribute: "muscular_endurance", weight: 0.4 }, { attribute: "speed", weight: 0.15 }], fatigueExponent: 1.15, maxSet: 40 },
  ...
  { id: "squat_jump", name: "Squat jump", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.85, rate: r(0.85, 0.78, 0.55, 0.48, 0.38, 0.32), attributes: [{ attribute: "power", weight: 0.55 }, { attribute: "muscular_endurance", weight: 0.25 }, { attribute: "engine", weight: 0.2 }], fatigueExponent: 1.22, maxSet: 20 },
