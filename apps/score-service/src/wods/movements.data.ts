...
export const MOVEMENTS: MovementDef[] = [
  ...
  { id: "wall_walk", name: "Wall walk", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.9, rate: r(0.26, 0.21, 0.14, 0.1, 0.06, 0.03), attributes: [{ attribute: "strength", weight: 0.5 }, { attribute: "muscular_endurance", weight: 0.4 }, { attribute: "engine", weight: 0.1 }], fatigueExponent: 1.4, maxSet: 6 },
  ...
  { id: "clean", name: "Power clean", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.76, rate: r(0.55, 0.46, 0.28, 0.22, 0.14, 0.1), attributes: [{ attribute: "power", weight: 0.55 }, { attribute: "strength", weight: 0.35 }, { attribute: "muscular_endurance", weight: 0.1 }], fatigueExponent: 1.55, maxSet: 5 },
