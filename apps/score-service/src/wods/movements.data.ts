...
export const MOVEMENTS: MovementDef[] = [
  ...
  { id: "air_squat", name: "Squat", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.85, rate: r(1.05, 1.0, 0.7, 0.66, 0.48, 0.44), attributes: [{ attribute: "muscular_endurance", weight: 0.7 }, { attribute: "power", weight: 0.3 }], fatigueExponent: 1.12 },
  // Mountain climber : poids de corps, cadence rapide en planche (genoux alternés). 1 rep = 1 montée
  // de genou. Cardio-core dominant + tempo → engine/endurance musculaire + un peu de vitesse. Sert à
  // « Le Forgeron » (séance de la semaine) si on la rend loguable un jour.
  { id: "mountain_climber", name: "Mountain climber", category: "gymnastics", unit: "rep", requiresEquipment: false, rate: r(1.6, 1.4, 1.1, 0.95, 0.75, 0.65), attributes: [{ attribute: "engine", weight: 0.45 }, { attribute: "speed", weight: 0.25 }, { attribute: "muscular_endurance", weight: 0.3 }], fatigueExponent: 1.15, maxSet: 40 },
  ...
  { id: "burpee_broad_jump", name: "Burpee broad jump (reps)", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.72, rate: r(0.40, 0.34, 0.22, 0.18, 0.13, 0.10), attributes: [{ attribute: "engine", weight: 0.35 }, { attribute: "power", weight: 0.25 }, { attribute: "muscular_endurance", weight: 0.2 }, { attribute: "speed", weight: 0.1 }, { attribute: "hybrid", weight: 0.1 }], fatigueExponent: 1.3, maxSet: 10 },
  { id: "burpee_broad_jump_m", name: "Burpee broad jump (distance)", category: "gymnastics", unit: "meter", requiresEquipment: false, loadFactor: 0.72, rate: r(0.72, 0.61, 0.40, 0.32, 0.23, 0.18), attributes: [{ attribute: "engine", weight: 0.35 }, { attribute: "power", weight: 0.25 }, { attribute: "muscular_endurance", weight: 0.2 }, { attribute: "speed", weight: 0.1 }, { attribute: "hybrid", weight: 0.1 }], fatigueExponent: 1.22, maxSet: 1000 },
  { id: "box_jump", name: "Box jump", category: "gymnastics", unit: "rep", requiresEquipment: true, loadFactor: 1.0, rate: r(0.7, 0.62, 0.45, 0.38, 0.28, 0.22), attributes: [{ attribute: "power", weight: 0.45 }, { attribute: "muscular_endurance", weight: 0.3 }, { attribute: "speed", weight: 0.15 }, { attribute: "engine", weight: 0.1 }], fatigueExponent: 1.2 },
  { id: "squat_jump", name: "Squat jump", category: "gymnastics", unit: "rep", requiresEquipment: false, loadFactor: 0.85, rate: r(0.85, 0.78, 0.55, 0.48, 0.38, 0.32), attributes: [{ attribute: "power", weight: 0.45 }, { attribute: "speed", weight: 0.2 }, { attribute: "muscular_endurance", weight: 0.2 }, { attribute: "engine", weight: 0.15 }], fatigueExponent: 1.22, maxSet: 20 },
  { id: "double_under", name: "Double-under", category: "gymnastics", unit: "rep", requiresEquipment: true, rate: r(3.0, 2.8, 1.6, 1.4, 0.7, 0.5), attributes: [{ attribute: "speed", weight: 0.4 }, { attribute: "engine", weight: 0.4 }, { attribute: "muscular_endurance", weight: 0.2 }], fatigueExponent: 1.08 },
  ...
  { id: "wall_ball", name: "Wall ball", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.11, rate: r(0.85, 0.75, 0.5, 0.42, 0.3, 0.24), attributes: [{ attribute: "power", weight: 0.45 }, { attribute: "muscular_endurance", weight: 0.35 }, { attribute: "engine", weight: 0.1 }, { attribute: "speed", weight: 0.1 }], fatigueExponent: 1.3 },
  ...
  { id: "clean", name: "Power clean", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.76, rate: r(0.32, 0.26, 0.15, 0.12, 0.075, 0.055), attributes: [{ attribute: "power", weight: 0.5 }, { attribute: "strength", weight: 0.35 }, { attribute: "speed", weight: 0.1 }, { attribute: "muscular_endurance", weight: 0.05 }], fatigueExponent: 1.55, maxSet: 4 },
  { id: "clean_and_jerk", name: "Clean & jerk", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.76, rate: r(0.5, 0.42, 0.25, 0.19, 0.12, 0.08), attributes: [{ attribute: "power", weight: 0.5 }, { attribute: "strength", weight: 0.35 }, { attribute: "speed", weight: 0.1 }, { attribute: "muscular_endurance", weight: 0.05 }], fatigueExponent: 1.48, maxSet: 5 },
  { id: "snatch", name: "Power snatch", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.54, rate: r(0.52, 0.44, 0.24, 0.18, 0.11, 0.07), attributes: [{ attribute: "power", weight: 0.55 }, { attribute: "strength", weight: 0.3 }, { attribute: "speed", weight: 0.15 }], fatigueExponent: 1.5, maxSet: 5 },
  ...
  { id: "kettlebell_swing", name: "Kettlebell swing", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.3, rate: r(0.9, 0.8, 0.55, 0.46, 0.34, 0.27), attributes: [{ attribute: "power", weight: 0.45 }, { attribute: "muscular_endurance", weight: 0.3 }, { attribute: "engine", weight: 0.15 }, { attribute: "speed", weight: 0.1 }], fatigueExponent: 1.28 },
  { id: "dumbbell_snatch", name: "DB snatch", category: "weightlifting", unit: "rep", requiresEquipment: true, loadFactor: 0.28, rate: r(0.62, 0.52, 0.34, 0.27, 0.18, 0.12), attributes: [{ attribute: "power", weight: 0.5 }, { attribute: "muscular_endurance", weight: 0.3 }, { attribute: "speed", weight: 0.1 }, { attribute: "strength", weight: 0.1 }], fatigueExponent: 1.35 },
  ...
  { id: "sprint", name: "Sprint (≤200m)", category: "monostructural", unit: "meter", requiresEquipment: false, rate: r(9.5, 8.4, 6.5, 5.8, 5.0, 4.4), attributes: [{ attribute: "speed", weight: 0.75 }, { attribute: "power", weight: 0.15 }, { attribute: "engine", weight: 0.1 }], fatigueExponent: 1.1 },
