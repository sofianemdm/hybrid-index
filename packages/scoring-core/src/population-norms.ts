...
export const POP_NORMS_V1: Record<Sex, Record<AttributeKey, PointTableModel>> = {
  male: {
    engine: table([
      [150, 0.05], [300, 0.35], [450, 0.65], [600, 0.85], [750, 0.95], [880, 0.985], [950, 0.995],
    ]),
    muscular_endurance: table([
      [150, 0.1], [330, 0.5], [450, 0.62], [600, 0.85], [720, 0.95], [850, 0.99], [950, 0.997],
    ]),
    strength: table([
      [150, 0.1], [350, 0.5], [500, 0.75], [680, 0.92], [820, 0.985], [950, 0.998],
    ]),
    power: table([
      [200, 0.15], [360, 0.5], [560, 0.8], [740, 0.95], [880, 0.99], [950, 0.997],
    ]),
    speed: table([
      [200, 0.15], [360, 0.5], [520, 0.75], [700, 0.93], [870, 0.99], [950, 0.997],
    ]),
    hybrid: table([
      [150, 0.1], [350, 0.55], [500, 0.78], [680, 0.92], [820, 0.985], [950, 0.998],
    ]),
  },
  female: {
    engine: table([
      [150, 0.05], [300, 0.38], [450, 0.68], [600, 0.87], [750, 0.96], [880, 0.988], [950, 0.996],
    ]),
    muscular_endurance: table([
      [150, 0.12], [330, 0.52], [450, 0.66], [600, 0.88], [720, 0.96], [850, 0.99], [950, 0.997],
    ]),
    strength: table([
      [150, 0.12], [350, 0.52], [500, 0.77], [680, 0.93], [820, 0.987], [950, 0.998],
    ]),
    power: table([
      [200, 0.17], [360, 0.52], [560, 0.82], [740, 0.96], [880, 0.99], [950, 0.997],
    ]),
    speed: table([
      [200, 0.17], [360, 0.53], [520, 0.78], [700, 0.94], [870, 0.99], [950, 0.997],
    ]),
    hybrid: table([
      [150, 0.12], [350, 0.57], [500, 0.8], [680, 0.93], [820, 0.987], [950, 0.998],
    ]),
  },
};
...
const DISPLAY_BANDS = [1, 2, 5, 10, 20, 30, 50] as const;
